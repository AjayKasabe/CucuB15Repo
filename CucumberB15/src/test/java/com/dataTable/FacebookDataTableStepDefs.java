...
//		driver = new FirefoxDriver();
	...
	//put selenium code use for putting
	@When("he enters following data")
	public void he_enters_following_data(DataTable table){       //data table written by cucumber
		//Initialize data table 
	      List<List<String>> data = table.raw();    //.raw() method by cucumber and List<List<string>> 2 dia array- collecton
